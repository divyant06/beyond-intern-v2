  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[300px] w-[300px] rounded-full bg-electric/5 blur-[150px]"
      />
        ...
        <div className="relative rounded-3xl glass-strong p-8 sm:p-10">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <a
                href="#"
                className="text-electric-light hover:text-electric transition-colors"
              >
                Forgot password?
              </a>
            </div>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 gradient-electric text-white font-semibold rounded-xl glow-blue hover:opacity-90 transition-opacity text-base"
            >
              {isLoading ? (
                <motion.div
                  animate={{ rotate: 360 }}
          ...
          <p className="mt-6 text-center text-sm text-slate-400">
            ...
            <Link
              href="/login"
              className="font-medium text-electric-light hover:text-electric transition-colors"
            >
              Create one free
            </Link>
          </p>
